...
var FOCUSED_POST_CHANGE = 'focused_post_change';
...
class PostStoreClass extends EventEmitter {
    ...
    getVisiblePosts(id) {
        if (this.postsInfo.hasOwnProperty(id) && this.postsInfo[id].hasOwnProperty('postList')) {
            const postList = Object.assign({}, this.postsInfo[id].postList);
            ...
            if (this.postsInfo[id].hasOwnProperty('deletedPosts')) {
                Object.assign(postList.posts, this.postsInfo[id].deletedPosts.posts);

                // Merge would be faster
                postList.order.concat(this.postsInfo[id].deletedPosts.order);
    ...
    getVisibilityAtBottom(id) {
        if (this.postsInfo.hasOwnProperty(id)) {
            return this.postsInfo[id].atBottom && this.postsInfo[id].startVisible === 0;
        }
...
PostStore.dispatchToken = AppDispatcher.register((payload) => {
    ...
    case ActionTypes.RECIEVED_FOCUSED_POST:
        PostStore.pStoreFocusedPost(action.postId, makePostListNonNull(action.post_list));
        PostStore.emitChange();
        break;
    ...
    case ActionTypes.CLICK_CHANNEL:
        ...
        PostStore.clearChannelVisibility(action.id);
